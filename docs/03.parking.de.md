...
Für Reservierungen schreiben Sie bitte an: [**reservation@petrs.cz**](mailto:reservation@petrs.cz)
...
<div class="gallery">
<figure>
  <img src="/assets/fotky_hotelu/parkovani.webp" alt="Blick auf das Hotel" style="width: 400px; height: 300px; object-fit: cover; border-radius: 8px;">
  <figcaption style="text-align: center; margin-top: 8px; font-weight: bold;">Hotelparkplatz</figcaption>
</figure>

<figure>
  <img src="/assets/fotky_hotelu/prijezdova-brana.webp" alt="Maße des Tors" style="width: 400px; height: 300px; object-fit: cover; border-radius: 8px; object-position: bottom;">
